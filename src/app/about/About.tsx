  ...
  return (
      <div className="flex flex-col justify-center relative  mx-auto container h-full p-6  my-6 space-y-6 rounded-lg shadow-lg">
        ...
        <div className="flex flex-col gap-4">
          <img whileHover={{rotate:50}} className="object-contain mx-auto max-w-max w-60  rounded-full" src="/pfp.png" />
        <p initial={{opacity:0}} whileInView={{opacity:1,transition:{duration:0.6,delay:0.25}}} className="text-gray-400 text-xl text-center font-custom2 font-extralight leading-relaxed
 md:w-1/2 mx-auto">
